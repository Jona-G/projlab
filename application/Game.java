...
public class Game extends JFrame implements KeyListener {
	...
	private static JTextArea infoTextArea  = new JTextArea(10, 80);
		...
		try {
			try (var in = new ObjectInputStream(new FileInputStream("save.txt"))) {
				try {
					...
					infoTextArea  = gameData.getInfoTextArea();
					canvas = gameData.getCanvas();
					bottomPanel = gameData.getBottomPanel();
